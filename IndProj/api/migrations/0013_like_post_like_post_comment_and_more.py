...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('api', '0012_remove_user_posts_remove_user_liked_posts_and_more'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('liked_by', models.ManyToManyField(blank=True, related_name='liked_posts', through='api.Like', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='like',
