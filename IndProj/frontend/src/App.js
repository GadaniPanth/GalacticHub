...
function App() {
  ...
  const logo =(
    <svg viewBox="0 0 369.57894736842104 90.08728573274055" class="looka-1j8o68f">
  ...
  return (<>
      {loading ? (
        ...
        /> */}
        <div className='navbar top-0 absolute w-full h-24 z-40'>
          <Navbar logo={logo}/>
        </div>
